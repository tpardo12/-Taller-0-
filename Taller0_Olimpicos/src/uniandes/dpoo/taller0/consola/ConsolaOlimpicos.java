...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. consultar el pais de medallista");
	 ...
	 */
	private void ejecutarpais() {
		String nombre = input("Por favor ingrese el nombre de un deportista");
		String pais = calculadora.a(nombre);
		System.out.println("La nacionalidad de " + nombre +  " es: " + pais);
	}

...
public class CalculadoraEstadisticas
{
	...
	// Métodos
	// ************************************************************************
    public String a(String nombre) {
    	
    	
    	Atleta att = buscarAtleta(nombre);
    	Pais pais = att.darPais();
	...
	public Map<String, List<Map<String, Object>>> medallistasPorNacionn(String nombrePais, Genero generoAtleta)
	{
		Map<String, List<Map<String, Object>>> resultado = null;
		Pais elPais = buscarPais(nombrePais);
		if (elPais != null)
